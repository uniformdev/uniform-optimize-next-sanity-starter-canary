...
import { CallToActionDocument } from '../lib/sanityTypes';
import WaveSplitter from './WaveSplitter';

const CallToActionComponent: React.FC<CallToActionDocument> = ({
  heading,
  subheading,
  buttonImage,
  buttonLink,
  ...
  <>
    ...
    <section className="container mx-auto text-center py-6 mb-12">
      ...
      {buttonLink && buttonImage && (
        ...
        >
          <img src={urlFor(buttonImage).url()} alt="button image" />
        </button>
      )}
      {buttonLink && !buttonImage && (
        <a
